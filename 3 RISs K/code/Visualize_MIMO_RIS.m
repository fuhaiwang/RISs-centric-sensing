function Visualize_MIMO_RIS(SOI_Position,SOI_XVector,SOI_YVector,SOI_ZVector,SOI_XNum,SOI_YNum,SOI_ZNum,SOI_Resolution, letter_coor,letter_index,Ei,risPosition,risRowVector,risColumnVector,risRowNum,risColNum,Rx,Ei_hat,pp)
...
%         axis off;
        save_path = '..\result\';
%         matlab2tikz(strcat(save_path,num2str(pp),'myfile.tex'));

        ax = gcf;
        str=strcat(save_path,'P=',num2str(pp),',N=',num2str(risColNum*risRowNum),'_',num2str(risRowNum),'Naer field 3D','.jpg');
