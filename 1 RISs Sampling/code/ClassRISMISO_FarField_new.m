...
classdef ClassRISMISO_FarField_new
    ...
    methods
        ...
        % Coordinate matrix of the array element (row*column)
        ...
        % Input the coordinate matrix of the SOI to obtain the angle of incidence, 2*M
        ...
        % Input Rx coordinates to obtain the Angle of departure, 2*1
...
%             if (max(obj.InterUnits*obj.NumOfRow,
%             obj.InterUnits*obj.NumOfColumn))^2*2/obj.Lambda_c -2 >
%             min(vecnorm(TxPosition-risPosition)) %dar 
%             if (max(obj.InterUnits*obj.NumOfRow,
%             obj.InterUnits*obj.NumOfColumn))^2*2/obj.Lambda_c -2 >
%             min(vecnorm(TxPosition-risPosition)) %far-field
