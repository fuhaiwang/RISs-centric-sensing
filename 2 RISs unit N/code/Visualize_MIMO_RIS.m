function Visualize_MIMO_RIS(SOI_Position,SOI_XVector,SOI_YVector,SOI_ZVector,SOI_XNum,SOI_YNum,SOI_ZNum,SOI_Resolution, letter_coor,letter_index,Ei,risPosition,risRowVector,risColumnVector,risRowNum,risColNum,Rx,Ei_hat,risNum)
