function [WT,Ei,M,num_x,num_y] = RIS2_1819(A_all)  
    N = 32; 
    ...
    n2 = [0.11,0.6];
    resolution = 1;
    yyy = yy.*resolution-RIS2_cor(2);
    xxx = xx.*resolution-RIS2_cor(1);

    r_i = sqrt((xxx - RIS2_cor(1)).^2 + (yyy - RIS2_cor(2) ).^2) ;
    r_i_vec = diag(reshape(r_i',[M,1]));

    theta_i_M_ = (atan2(yyy, xxx) - atan2(n2(2), n2(1)))*180/pi;
    ...
    for t=1:numofSamples
        ...
        phaseShiftMatrix_t = phaseShiftMatrix_t(10, 33:64); 
